...
public class RepeatedNarrator {
   ...
   public void narrate(GameNarrator gameNarrator, Component component) {
      RepeatedNarrator.Params params = (RepeatedNarrator.Params)this.params.updateAndGet((paramsx) -> {
         return paramsx != null && component.equals(paramsx.narration) ? paramsx : new RepeatedNarrator.Params(component, RateLimiter.create((double)this.permitsPerSecond));
      });
