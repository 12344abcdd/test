...
public class RealmsConnect {
   ...
   public void connect(RealmsServer realmsServer, ServerAddress serverAddress) {
      ...
      minecraft.getNarrator().sayNow((Component)Component.translatable("mco.connect.success"));
      ...
      (new Thread("Realms-connect-task") {
         public void run() {
            ...
            try {
               ...
               ClientHandshakePacketListenerImpl clientHandshakePacketListenerImpl = new ClientHandshakePacketListenerImpl(RealmsConnect.this.connection, minecraft, realmsServer.toServerData(string), RealmsConnect.this.onlineScreen, false, (Duration)null, (component) -> {
               }, (TransferState)null);
               ...
               DisconnectedRealmsScreen disconnectedRealmsScreen = new DisconnectedRealmsScreen(RealmsConnect.this.onlineScreen, CommonComponents.CONNECT_FAILED, Component.translatable("disconnect.genericReason", new Object[]{stringx}));
               minecraft.execute(() -> {
