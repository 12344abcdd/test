...
public class KeyMapping implements Comparable<KeyMapping> {
   ...
   public int compareTo(KeyMapping keyMapping) {
      return this.category.equals(keyMapping.category) ? I18n.get(this.name).compareTo(I18n.get(keyMapping.name)) : ((Integer)CATEGORY_SORT_ORDER.get(this.category)).compareTo((Integer)CATEGORY_SORT_ORDER.get(keyMapping.category));
   }
