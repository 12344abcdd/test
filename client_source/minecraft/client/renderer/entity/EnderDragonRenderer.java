...
public class EnderDragonRenderer extends EntityRenderer<EnderDragon> {
   ...
   public void render(EnderDragon enderDragon, float f, float g, PoseStack poseStack, MultiBufferSource multiBufferSource, int i) {
      ...
      if (enderDragon.dragonDeathTime > 0) {
         ...
         int l = ARGB32.color(Mth.floor(k * 255.0F), -1);
      ...
      if (enderDragon.nearestCrystal != null) {
         poseStack.pushPose();
         m = (float)(enderDragon.nearestCrystal.getX() - Mth.lerp((double)g, enderDragon.xo, enderDragon.getX()));
   ...
   private static void renderRays(PoseStack poseStack, float f, VertexConsumer vertexConsumer) {
      ...
      int i = ARGB32.colorFromFloat(1.0F - g, 1.0F, 1.0F, 1.0F);
      int j = 16711935;
      ...
      for(int l = 0; l < k; ++l) {
         quaternionf.rotationXYZ(randomSource.nextFloat() * 6.2831855F, randomSource.nextFloat() * 6.2831855F, randomSource.nextFloat() * 6.2831855F).rotateXYZ(randomSource.nextFloat() * 6.2831855F, randomSource.nextFloat() * 6.2831855F, randomSource.nextFloat() * 6.2831855F + f * 1.5707964F);
   ...
   public static void renderCrystalBeams(float f, float g, float h, float i, int j, PoseStack poseStack, MultiBufferSource multiBufferSource, int k) {
      ...
      poseStack.mulPose(Axis.YP.rotation((float)(-Math.atan2((double)h, (double)f)) - 1.5707964F));
      poseStack.mulPose(Axis.XP.rotation((float)(-Math.atan2((double)l, (double)g)) - 1.5707964F));
      ...
      for(int t = 1; t <= 8; ++t) {
         float u = Mth.sin((float)t * 6.2831855F / 8.0F) * 0.75F;
         float v = Mth.cos((float)t * 6.2831855F / 8.0F) * 0.75F;
         float w = (float)t / 8.0F;
         vertexConsumer.addVertex(pose, q * 0.2F, r * 0.2F, 0.0F).setColor(-16777216).setUv(s, n).setOverlay(OverlayTexture.NO_OVERLAY).setLight(k).setNormal(pose, 0.0F, -1.0F, 0.0F);
         ...
         vertexConsumer.addVertex(pose, u * 0.2F, v * 0.2F, 0.0F).setColor(-16777216).setUv(w, n).setOverlay(OverlayTexture.NO_OVERLAY).setLight(k).setNormal(pose, 0.0F, -1.0F, 0.0F);
         q = u;
         r = v;
         s = w;
      }
   ...
   public static class DragonModel extends EntityModel<EnderDragon> {
      ...
      public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int i, int j, int k) {
         ...
         this.jaw.xRot = (float)(Math.sin((double)(f * 6.2831855F)) + 1.0D) * 0.2F;
         ...
         for(int r = 0; r < 5; ++r) {
            ...
            s = (float)Math.cos((double)((float)r * 0.45F + q)) * 0.15F;
            this.neck.yRot = Mth.wrapDegrees((float)(es[0] - ds[0])) * 0.017453292F * 1.5F;
            this.neck.xRot = s + this.entity.getHeadPartYOffset(r, ds, es) * 0.017453292F * 1.5F * 5.0F;
            this.neck.zRot = -Mth.wrapDegrees((float)(es[0] - (double)p)) * 0.017453292F * 1.5F;
            this.neck.y = l;
            this.neck.z = m;
            this.neck.x = h;
         ...
         this.head.yRot = Mth.wrapDegrees((float)(fs[0] - ds[0])) * 0.017453292F;
         this.head.xRot = Mth.wrapDegrees(this.entity.getHeadPartYOffset(6, ds, fs)) * 0.017453292F * 1.5F * 5.0F;
         this.head.zRot = -Mth.wrapDegrees((float)(fs[0] - (double)p)) * 0.017453292F;
         ...
         float t = f * 6.2831855F;
         this.leftWing.xRot = 0.125F - (float)Math.cos((double)t) * 0.2F;
         this.leftWing.yRot = -0.25F;
         this.leftWing.zRot = -((float)(Math.sin((double)t) + 0.125D)) * 0.8F;
         this.leftWingTip.zRot = (float)(Math.sin((double)(t + 2.0F)) + 0.5D) * 0.75F;
         ...
         for(int u = 0; u < 12; ++u) {
            ...
            this.neck.yRot = (Mth.wrapDegrees((float)(fs[0] - ds[0])) * 1.5F + 180.0F) * 0.017453292F;
            this.neck.xRot = s + (float)(fs[1] - ds[1]) * 0.017453292F * 1.5F * 5.0F;
            this.neck.zRot = Mth.wrapDegrees((float)(fs[0] - (double)p)) * 0.017453292F * 1.5F;
            this.neck.y = l;
            this.neck.z = m;
            this.neck.x = h;
            l += Mth.sin(this.neck.xRot) * 10.0F;
