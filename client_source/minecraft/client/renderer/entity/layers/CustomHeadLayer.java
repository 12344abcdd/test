...
public class CustomHeadLayer<T extends LivingEntity, M extends EntityModel<T> & HeadedModel> extends RenderLayer<T, M> {
   ...
   private final Map<Type, SkullModelBase> skullModels;
   ...
   public void render(PoseStack poseStack, MultiBufferSource multiBufferSource, int i, T livingEntity, float f, float g, float h, float j, float k, float l) {
      ...
      if (!itemStack.isEmpty()) {
         ...
         if (item instanceof BlockItem && ((BlockItem)item).getBlock() instanceof AbstractSkullBlock) {
            ...
            Type type = ((AbstractSkullBlock)((BlockItem)item).getBlock()).getType();
            ...
            SkullBlockRenderer.renderSkull((Direction)null, 180.0F, o, poseStack, multiBufferSource, i, skullModelBase, renderType);
         } else {
            label54: {
