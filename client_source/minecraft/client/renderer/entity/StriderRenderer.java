...
public class StriderRenderer extends MobRenderer<Strider, StriderModel<Strider>> {
   ...
   public StriderRenderer(EntityRendererProvider.Context context) {
      ...
      this.addLayer(new SaddleLayer(this, new StriderModel(context.bakeLayer(ModelLayers.STRIDER_SADDLE)), ResourceLocation.withDefaultNamespace("textures/entity/strider/strider_saddle.png")));
   }
   ...
   protected float getShadowRadius(Strider strider) {
      float f = super.getShadowRadius((Mob)strider);
