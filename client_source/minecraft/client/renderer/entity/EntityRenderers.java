...
public class EntityRenderers {
   ...
   public static Map<EntityType<?>, EntityRenderer<?>> createEntityRenderers(EntityRendererProvider.Context context) {
      ...
      PROVIDERS.forEach((entityType, entityRendererProvider) -> {
         try {
            ...
            throw new IllegalArgumentException("Failed to create model for " + String.valueOf(BuiltInRegistries.ENTITY_TYPE.getKey(entityType)), var5);
         }
      });
   ...
   static {
      PLAYER_PROVIDERS = Map.of(PlayerSkin.Model.WIDE, (context) -> {
         return new PlayerRenderer(context, false);
      }, PlayerSkin.Model.SLIM, (context) -> {
         return new PlayerRenderer(context, true);
      });
      ...
      register(EntityType.CAMEL, (context) -> {
         return new CamelRenderer(context, ModelLayers.CAMEL);
      });
      ...
      register(EntityType.COMMAND_BLOCK_MINECART, (context) -> {
         return new MinecartRenderer(context, ModelLayers.COMMAND_BLOCK_MINECART);
      });
      ...
      register(EntityType.DONKEY, (context) -> {
         return new ChestedHorseRenderer(context, 0.87F, ModelLayers.DONKEY);
      });
      ...
      register(EntityType.FURNACE_MINECART, (context) -> {
         return new MinecartRenderer(context, ModelLayers.FURNACE_MINECART);
      });
      ...
      register(EntityType.GLOW_SQUID, (context) -> {
         return new GlowSquidRenderer(context, new SquidModel(context.bakeLayer(ModelLayers.GLOW_SQUID)));
      });
      ...
      register(EntityType.LLAMA, (context) -> {
         return new LlamaRenderer(context, ModelLayers.LLAMA);
      });
      ...
      register(EntityType.MULE, (context) -> {
         return new ChestedHorseRenderer(context, 0.92F, ModelLayers.MULE);
      });
      ...
      register(EntityType.PIGLIN, (context) -> {
         return new PiglinRenderer(context, ModelLayers.PIGLIN, ModelLayers.PIGLIN_INNER_ARMOR, ModelLayers.PIGLIN_OUTER_ARMOR, false);
      });
      register(EntityType.PIGLIN_BRUTE, (context) -> {
         return new PiglinRenderer(context, ModelLayers.PIGLIN_BRUTE, ModelLayers.PIGLIN_BRUTE_INNER_ARMOR, ModelLayers.PIGLIN_BRUTE_OUTER_ARMOR, false);
      });
      ...
      register(EntityType.SKELETON_HORSE, (context) -> {
         return new UndeadHorseRenderer(context, ModelLayers.SKELETON_HORSE);
      });
      ...
      register(EntityType.SPAWNER_MINECART, (context) -> {
         return new MinecartRenderer(context, ModelLayers.SPAWNER_MINECART);
      });
      ...
      register(EntityType.SQUID, (context) -> {
         return new SquidRenderer(context, new SquidModel(context.bakeLayer(ModelLayers.SQUID)));
      });
      ...
      register(EntityType.TRADER_LLAMA, (context) -> {
         return new LlamaRenderer(context, ModelLayers.TRADER_LLAMA);
      });
      ...
      register(EntityType.ZOMBIE_HORSE, (context) -> {
         return new UndeadHorseRenderer(context, ModelLayers.ZOMBIE_HORSE);
      });
      register(EntityType.ZOMBIE_VILLAGER, ZombieVillagerRenderer::new);
      register(EntityType.ZOMBIFIED_PIGLIN, (context) -> {
         return new PiglinRenderer(context, ModelLayers.ZOMBIFIED_PIGLIN, ModelLayers.ZOMBIFIED_PIGLIN_INNER_ARMOR, ModelLayers.ZOMBIFIED_PIGLIN_OUTER_ARMOR, true);
      });
   }
}
