...
public class VindicatorRenderer extends IllagerRenderer<Vindicator> {
   ...
   public VindicatorRenderer(EntityRendererProvider.Context context) {
      ...
      this.addLayer(new ItemInHandLayer<Vindicator, IllagerModel<Vindicator>>(this, this, context.getItemInHandRenderer()) {
         public void render(PoseStack poseStack, MultiBufferSource multiBufferSource, int i, Vindicator vindicator, float f, float g, float h, float j, float k, float l) {
            if (vindicator.isAggressive()) {
               super.render(poseStack, multiBufferSource, i, (LivingEntity)vindicator, f, g, h, j, k, l);
            }
