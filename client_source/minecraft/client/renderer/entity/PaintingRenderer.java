...
public class PaintingRenderer extends EntityRenderer<Painting> {
   ...
   public void render(Painting painting, float f, float g, PoseStack poseStack, MultiBufferSource multiBufferSource, int i) {
      ...
      this.renderPainting(poseStack, vertexConsumer, painting, paintingVariant.width(), paintingVariant.height(), paintingTextureManager.get(paintingVariant), paintingTextureManager.getBackSprite());
      poseStack.popPose();
