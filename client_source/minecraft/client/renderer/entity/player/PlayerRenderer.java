...
public class PlayerRenderer extends LivingEntityRenderer<AbstractClientPlayer, PlayerModel<AbstractClientPlayer>> {
   ...
   public void render(AbstractClientPlayer abstractClientPlayer, float f, float g, PoseStack poseStack, MultiBufferSource multiBufferSource, int i) {
      ...
      super.render((LivingEntity)abstractClientPlayer, f, g, poseStack, multiBufferSource, i);
   }

   public Vec3 getRenderOffset(AbstractClientPlayer abstractClientPlayer, float f) {
      return abstractClientPlayer.isCrouching() ? new Vec3(0.0D, (double)(abstractClientPlayer.getScale() * -2.0F) / 16.0D, 0.0D) : super.getRenderOffset(abstractClientPlayer, f);
   }
   ...
   protected void renderNameTag(AbstractClientPlayer abstractClientPlayer, Component component, PoseStack poseStack, MultiBufferSource multiBufferSource, int i, float f) {
      ...
      if (d < 100.0D) {
         ...
         if (objective != null) {
            ...
            super.renderNameTag(abstractClientPlayer, Component.empty().append(component2).append(CommonComponents.SPACE).append(objective.getDisplayName()), poseStack, multiBufferSource, i, f);
   ...
   protected void setupRotations(AbstractClientPlayer abstractClientPlayer, PoseStack poseStack, float f, float g, float h, float i) {
      ...
      if (abstractClientPlayer.isFallFlying()) {
         ...
         l = (float)abstractClientPlayer.getFallFlyingTicks() + h;
         ...
         super.setupRotations(abstractClientPlayer, poseStack, f, g, h, i);
         l = abstractClientPlayer.isInWater() ? -90.0F - k : -90.0F;
         m = Mth.lerp(j, 0.0F, l);
