...
public class WardenRenderer extends MobRenderer<Warden, WardenModel<Warden>> {
   ...
   public WardenRenderer(EntityRendererProvider.Context context) {
      ...
      this.addLayer(new WardenEmissiveLayer(this, BIOLUMINESCENT_LAYER_TEXTURE, (warden, f, g) -> {
         return 1.0F;
      }, WardenModel::getBioluminescentLayerModelParts));
      this.addLayer(new WardenEmissiveLayer(this, PULSATING_SPOTS_TEXTURE_1, (warden, f, g) -> {
         return Math.max(0.0F, Mth.cos(g * 0.045F) * 0.25F);
      }, WardenModel::getPulsatingSpotsLayerModelParts));
      this.addLayer(new WardenEmissiveLayer(this, PULSATING_SPOTS_TEXTURE_2, (warden, f, g) -> {
         return Math.max(0.0F, Mth.cos(g * 0.045F + 3.1415927F) * 0.25F);
      }, WardenModel::getPulsatingSpotsLayerModelParts));
      this.addLayer(new WardenEmissiveLayer(this, TEXTURE, (warden, f, g) -> {
         return warden.getTendrilAnimation(f);
      }, WardenModel::getTendrilsLayerModelParts));
      this.addLayer(new WardenEmissiveLayer(this, HEART_TEXTURE, (warden, f, g) -> {
         return warden.getHeartAnimation(f);
