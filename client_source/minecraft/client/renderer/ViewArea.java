...
public class ViewArea {
         ...
         for(int j = 0; j < this.sectionGridSizeX; ++j) {
            for(int k = 0; k < this.sectionGridSizeY; ++k) {
               for(int l = 0; l < this.sectionGridSizeZ; ++l) {
                  ...
                  var10000[m] = sectionRenderDispatcher.new RenderSection(m, j * 16, this.level.getMinBuildHeight() + k * 16, l * 16);
               }
            }
         }
   ...
   public void releaseAllBuffers() {
      ...
      for(int var3 = 0; var3 < var2; ++var3) {
         SectionRenderDispatcher.RenderSection renderSection = var1[var3];
