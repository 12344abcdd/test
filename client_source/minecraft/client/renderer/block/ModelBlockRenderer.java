...
public class ModelBlockRenderer {
   ...
   public void tesselateWithAO(BlockAndTintGetter blockAndTintGetter, BakedModel bakedModel, BlockState blockState, BlockPos blockPos, PoseStack poseStack, VertexConsumer vertexConsumer, boolean bl, RandomSource randomSource, long l, int i) {
      ...
      MutableBlockPos mutableBlockPos = blockPos.mutable();
      ...
      randomSource.setSeed(l);
      List<BakedQuad> list2 = bakedModel.getQuads(blockState, (Direction)null, randomSource);
      if (!list2.isEmpty()) {
   ...
   public void renderModel(PoseStack.Pose pose, VertexConsumer vertexConsumer, @Nullable BlockState blockState, BakedModel bakedModel, float f, float g, float h, int i, int j) {
      ...
      randomSource.setSeed(42L);
      renderQuadList(pose, vertexConsumer, f, g, h, bakedModel.getQuads(blockState, (Direction)null, randomSource), i, j);
   }
   ...
   private static void renderQuadList(PoseStack.Pose pose, VertexConsumer vertexConsumer, float f, float g, float h, List<BakedQuad> list, int i, int j) {
      ...
      float l;
      float m;
      for(Iterator var8 = list.iterator(); var8.hasNext(); vertexConsumer.putBulkData(pose, bakedQuad, k, l, m, 1.0F, i, j)) {
   ...
   private static class Cache {
      ...
      private final Long2IntLinkedOpenHashMap colorCache = (Long2IntLinkedOpenHashMap)Util.make(() -> {
         Long2IntLinkedOpenHashMap long2IntLinkedOpenHashMap = new Long2IntLinkedOpenHashMap(100, 0.25F) {
            // $FF: synthetic field
            final ModelBlockRenderer.Cache field_19323;

            {
               super(i, f);
               this.field_19323 = cache;
            }
      ...
      private final Long2FloatLinkedOpenHashMap brightnessCache = (Long2FloatLinkedOpenHashMap)Util.make(() -> {
         Long2FloatLinkedOpenHashMap long2FloatLinkedOpenHashMap = new Long2FloatLinkedOpenHashMap(100, 0.25F) {
            // $FF: synthetic field
            final ModelBlockRenderer.Cache field_19324;

            {
               super(i, f);
               this.field_19324 = cache;
            }
   ...
   protected static enum AdjacencyInfo {
      ...
      private static final ModelBlockRenderer.AdjacencyInfo[] BY_FACING = (ModelBlockRenderer.AdjacencyInfo[])Util.make(new ModelBlockRenderer.AdjacencyInfo[6], (adjacencyInfos) -> {
      ...
      private AdjacencyInfo(final Direction[] directions, final float f, final boolean bl, final ModelBlockRenderer.SizeInfo[] sizeInfos, final ModelBlockRenderer.SizeInfo[] sizeInfos2, final ModelBlockRenderer.SizeInfo[] sizeInfos3, final ModelBlockRenderer.SizeInfo[] sizeInfos4) {
   ...
   private static enum AmbientVertexRemap {
      ...
      final int vert2;
      final int vert3;
      private static final ModelBlockRenderer.AmbientVertexRemap[] BY_FACING = (ModelBlockRenderer.AmbientVertexRemap[])Util.make(new ModelBlockRenderer.AmbientVertexRemap[6], (ambientVertexRemaps) -> {
