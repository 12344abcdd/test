...
public class Frustum {
   ...
   public Frustum offsetToFullyIncludeCameraCube(int i) {
      ...
      for(double j = Math.ceil(this.camZ / (double)i) * (double)i; this.intersection.intersectAab((float)(d - this.camX), (float)(e - this.camY), (float)(f - this.camZ), (float)(g - this.camX), (float)(h - this.camY), (float)(j - this.camZ)) != -2; this.camZ -= (double)(this.viewVector.z() * 4.0F)) {
