...
public class DirectoryLister implements SpriteSource {
   public static final MapCodec<DirectoryLister> CODEC = RecordCodecBuilder.mapCodec((instance) -> {
      return instance.group(Codec.STRING.fieldOf("source").forGetter((directoryLister) -> {
         return directoryLister.sourcePath;
      }), Codec.STRING.fieldOf("prefix").forGetter((directoryLister) -> {
         return directoryLister.idPrefix;
