...
public class SourceFilter implements SpriteSource {
   public static final MapCodec<SourceFilter> CODEC = RecordCodecBuilder.mapCodec((instance) -> {
      return instance.group(ResourceLocationPattern.CODEC.fieldOf("pattern").forGetter((sourceFilter) -> {
         return sourceFilter.filter;
