...
public class SpriteSourceList {
   ...
   public List<Function<SpriteResourceLoader, SpriteContents>> list(ResourceManager resourceManager) {
      ...
      SpriteSource.Output output = new SpriteSource.Output(this) {
      ...
      this.sources.forEach((spriteSource) -> {
         spriteSource.run(resourceManager, output);
      });
   ...
   public static SpriteSourceList load(ResourceManager resourceManager, ResourceLocation resourceLocation) {
      ...
      Iterator var4 = resourceManager.getResourceStack(resourceLocation2).iterator();
      ...
      while(var4.hasNext()) {
         ...
         try {
            ...
            LOGGER.error("Failed to parse atlas definition {} in pack {}", new Object[]{resourceLocation2, resource.sourcePackId(), var11});
         }
      }
