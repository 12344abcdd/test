...
public class HttpTexture extends SimpleTexture {
   ...
   public void load(ResourceManager resourceManager) throws IOException {
      ...
      if (this.future == null) {
         ...
         if (this.file != null && this.file.isFile()) {
            ...
            nativeImage = this.load((InputStream)fileInputStream);
         } else {
            nativeImage = null;
         }
   ...
   private NativeImage processLegacySkin(NativeImage nativeImage) {
      ...
      if (j == 64 && (i == 32 || i == 64)) {
         ...
         nativeImage.close();
         LOGGER.warn("Discarding incorrectly sized ({}x{}) skin texture from {}", new Object[]{j, i, this.urlString});
         return null;
      }
   }
   ...
   private static void setNoAlpha(NativeImage nativeImage, int i, int j, int k, int l) {
      for(int m = i; m < k; ++m) {
         for(int n = j; n < l; ++n) {
            nativeImage.setPixelRGBA(m, n, nativeImage.getPixelRGBA(m, n) | -16777216);
         }
      }
