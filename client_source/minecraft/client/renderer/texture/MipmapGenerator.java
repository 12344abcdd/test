...
public class MipmapGenerator {
   ...
   private static int alphaBlend(int i, int j, int k, int l, boolean bl) {
      if (bl) {
         ...
         h /= 4.0F;
         m /= 4.0F;
         int n = (int)(Math.pow((double)f, 0.45454545454545453D) * 255.0D);
         int o = (int)(Math.pow((double)g, 0.45454545454545453D) * 255.0D);
         int p = (int)(Math.pow((double)h, 0.45454545454545453D) * 255.0D);
         int q = (int)(Math.pow((double)m, 0.45454545454545453D) * 255.0D);
         if (n < 96) {
            n = 0;
         }
   ...
   private static int gammaBlend(int i, int j, int k, int l, int m) {
      ...
      float o = (float)((double)((float)Math.pow((double)(f + g + h + n) * 0.25D, 0.45454545454545453D)));
      return (int)((double)o * 255.0D);
   }
