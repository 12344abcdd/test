...
public final class MissingTextureAtlasSprite {
   ...
   static {
      SPRITE_METADATA = (new Builder()).put(AnimationMetadataSection.SERIALIZER, new AnimationMetadataSection(ImmutableList.of(new AnimationFrame(0, -1)), 16, 16, 1, false)).build();
   }
}
