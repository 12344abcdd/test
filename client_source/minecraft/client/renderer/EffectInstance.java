   ...
   public EffectInstance(ResourceProvider resourceProvider, String string) throws IOException {
      ...
      try {
         ...
         try {
            ...
            JsonArray jsonArray2 = GsonHelper.getAsJsonArray(jsonObject, "attributes", (JsonArray)null);
            Iterator var27;
            if (jsonArray2 != null) {
               int j = 0;
            ...
            JsonArray jsonArray3 = GsonHelper.getAsJsonArray(jsonObject, "uniforms", (JsonArray)null);
            if (jsonArray3 != null) {
               int k = 0;
         ...
         chainedJsonException4.setFilenameAndFlush(var10001 + " (" + resource.sourcePackId() + ")");
