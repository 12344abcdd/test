...
public class ShaderInstance implements Shader, AutoCloseable {
      ...
      try {
         ...
         try {
            ...
            if (jsonArray2 != null) {
               ...
               for(var24 = jsonArray2.iterator(); var24.hasNext(); ++j) {
                  JsonElement jsonElement2 = (JsonElement)var24.next();
            ...
            for(var24 = vertexFormat.getElementAttributeNames().iterator(); var24.hasNext(); ++j) {
               String string4 = (String)var24.next();
         ...
         try {
            ...
            program2 = Program.compileShader(type, string, inputStream, resource.sourcePackId(), new GlslPreprocessor() {
               ...
               public String applyImport(boolean bl, String string) {
                  String var10000 = bl ? string3 : "shaders/include/";
                  string = FileUtil.normalizeResourcePath(var10000 + string);
   ...
   private void parseSamplerNode(JsonElement jsonElement) {
      ...
      if (!GsonHelper.isStringValue(jsonObject, "file")) {
         this.samplerMap.put(string, (Object)null);
