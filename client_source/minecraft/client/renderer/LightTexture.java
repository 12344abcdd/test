...
public class LightTexture implements AutoCloseable {
   ...
   private float calculateDarknessScale(LivingEntity livingEntity, float f, float g) {
      float h = 0.45F * f;
      return Math.max(0.0F, Mth.cos(((float)livingEntity.tickCount - g) * 3.1415927F * 0.025F) * h);
   }
         ...
         if (clientLevel != null) {
            ...
            for(int o = 0; o < 16; ++o) {
               for(int p = 0; p < 16; ++p) {
                  ...
                  w = ((Double)this.minecraft.options.gamma().get()).floatValue();
                  ...
                  this.lightPixels.setPixelRGBA(p, o, -16777216 | aa << 16 | z << 8 | y);
               }
            }
