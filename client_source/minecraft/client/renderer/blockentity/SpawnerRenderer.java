...
public class SpawnerRenderer implements BlockEntityRenderer<SpawnerBlockEntity> {
   ...
   public static void renderEntityInSpawner(float f, PoseStack poseStack, MultiBufferSource multiBufferSource, int i, Entity entity, EntityRenderDispatcher entityRenderDispatcher, double d, double e) {
      poseStack.pushPose();
