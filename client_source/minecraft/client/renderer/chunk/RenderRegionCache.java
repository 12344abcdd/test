...
public class RenderRegionCache {
   ...
   private RenderRegionCache.ChunkInfo getChunkInfo(Level level, int i, int j) {
      return (RenderRegionCache.ChunkInfo)this.chunkInfoCache.computeIfAbsent(ChunkPos.asLong(i, j), (l) -> {
         return new RenderRegionCache.ChunkInfo(level.getChunk(ChunkPos.getX(l), ChunkPos.getZ(l)));
      });
   }
