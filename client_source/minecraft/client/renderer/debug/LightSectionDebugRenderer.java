...
public class LightSectionDebugRenderer implements DebugRenderer.SimpleDebugRenderer {
   ...
   private static void renderFaces(PoseStack poseStack, DiscreteVoxelShape discreteVoxelShape, SectionPos sectionPos, VertexConsumer vertexConsumer, double d, double e, double f, Vector4f vector4f) {
   ...
   private static void renderEdges(PoseStack poseStack, DiscreteVoxelShape discreteVoxelShape, SectionPos sectionPos, MultiBufferSource multiBufferSource, double d, double e, double f, Vector4f vector4f) {
   ...
   private static void renderFace(PoseStack poseStack, VertexConsumer vertexConsumer, Direction direction, double d, double e, double f, int i, int j, int k, Vector4f vector4f) {
      ...
      LevelRenderer.renderFace(poseStack, vertexConsumer, direction, g, h, l, g + 16.0F, h + 16.0F, l + 16.0F, vector4f.x(), vector4f.y(), vector4f.z(), vector4f.w());
   }

   private static void renderEdge(PoseStack poseStack, VertexConsumer vertexConsumer, double d, double e, double f, int i, int j, int k, int l, int m, int n, Vector4f vector4f) {
      float g = (float)((double)SectionPos.sectionToBlockCoord(i) - d);
      float h = (float)((double)SectionPos.sectionToBlockCoord(j) - e);
