...
public class MusicManager {
   ...
   public void tick() {
      ...
      if (this.currentMusic != null) {
         if (!((SoundEvent)music.getEvent().value()).getLocation().equals(this.currentMusic.getLocation()) && music.replaceCurrentMusic()) {
   ...
   public void startPlaying(Music music) {
      this.currentMusic = SimpleSoundInstance.forMusic((SoundEvent)music.getEvent().value());
   ...
   public boolean isPlayingMusic(Music music) {
      return this.currentMusic == null ? false : ((SoundEvent)music.getEvent().value()).getLocation().equals(this.currentMusic.getLocation());
   }
}
