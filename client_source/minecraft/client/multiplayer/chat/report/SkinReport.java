   ...
   public static class Builder extends Report.Builder<SkinReport> {
      ...
      public Either<Report.Result, Report.CannotBuildReason> build(ReportingContext reportingContext) {
         ...
         if (cannotBuildReason != null) {
            ...
            String string = ((ReportReason)Objects.requireNonNull(((SkinReport)this.report).reason)).backendName();
            ReportedEntity reportedEntity = new ReportedEntity(((SkinReport)this.report).reportedProfileId);
            PlayerSkin playerSkin = (PlayerSkin)((SkinReport)this.report).skinGetter.get();
            String string2 = playerSkin.textureUrl();
            AbuseReport abuseReport = AbuseReport.skin(((SkinReport)this.report).comments, string, string2, reportedEntity, ((SkinReport)this.report).createdAt);
