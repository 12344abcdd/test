...
public final class ReportingContext {
   ...
   public void draftReportHandled(Minecraft minecraft, Screen screen, Runnable runnable, boolean bl) {
      if (this.draftReport != null) {
         ...
         minecraft.setScreen(new ConfirmScreen((blx) -> {
         ...
         }, Component.translatable(bl ? "gui.abuseReport.draft.quittotitle.title" : "gui.abuseReport.draft.title"), Component.translatable(bl ? "gui.abuseReport.draft.quittotitle.content" : "gui.abuseReport.draft.content"), Component.translatable("gui.abuseReport.draft.edit"), Component.translatable("gui.abuseReport.draft.discard")));
      } else {
         runnable.run();
      }
