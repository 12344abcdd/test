...
public class ClientChunkCache extends ChunkSource {
   ...
   @Nullable
   public LevelChunk replaceWithPacketData(int i, int j, FriendlyByteBuf friendlyByteBuf, CompoundTag compoundTag, Consumer<BlockEntityTagOutput> consumer) {
      if (!this.storage.inRange(i, j)) {
         LOGGER.warn("Ignoring chunk since it's not in the view range: {}, {}", i, j);
         return null;
      } else {
   ...
   // $FF: synthetic method
   @Nullable
   public ChunkAccess getChunk(final int i, final int j, final ChunkStatus chunkStatus, final boolean bl) {
