...
public class CherryParticle extends TextureSheetParticle {
   ...
   public void tick() {
      ...
      if (!this.removed) {
         ...
         double d = Math.cos(Math.toRadians((double)(this.particleRandom * 60.0F))) * 2.0D * Math.pow((double)g, 1.25D);
         double e = Math.sin(Math.toRadians((double)(this.particleRandom * 60.0F))) * 2.0D * Math.pow((double)g, 1.25D);
