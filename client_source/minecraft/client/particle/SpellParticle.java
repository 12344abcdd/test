...
public class SpellParticle extends TextureSheetParticle {
   ...
   SpellParticle(ClientLevel clientLevel, double d, double e, double f, double g, double h, double i, SpriteSet spriteSet) {
      super(clientLevel, d, e, f, 0.5D - RANDOM.nextDouble(), h, 0.5D - RANDOM.nextDouble());
      this.friction = 0.96F;
      this.gravity = -0.1F;
   ...
   public static class MobEffectProvider implements ParticleProvider<ColorParticleOption> {
      ...
      // $FF: synthetic method
      public Particle createParticle(final ParticleOptions particleOptions, final ClientLevel clientLevel, final double d, final double e, final double f, final double g, final double h, final double i) {
         return this.createParticle((ColorParticleOption)particleOptions, clientLevel, d, e, f, g, h, i);
      }
   }
