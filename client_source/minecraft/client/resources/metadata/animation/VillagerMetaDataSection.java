...
public class VillagerMetaDataSection {
   ...
   public static enum Hat {
      ...
      private static final Map<String, VillagerMetaDataSection.Hat> BY_NAME = (Map)Arrays.stream(values()).collect(Collectors.toMap(VillagerMetaDataSection.Hat::getName, (hat) -> {
         return hat;
      }));
