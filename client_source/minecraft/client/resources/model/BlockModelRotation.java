...
public enum BlockModelRotation implements ModelState {
   ...
   private static final Map<Integer, BlockModelRotation> BY_INDEX = (Map)Arrays.stream(values()).collect(Collectors.toMap((blockModelRotation) -> {
   ...
   private BlockModelRotation(final int j, final int k) {
      ...
      Quaternionf quaternionf = (new Quaternionf()).rotateYXZ((float)(-k) * 0.017453292F, (float)(-j) * 0.017453292F, 0.0F);
