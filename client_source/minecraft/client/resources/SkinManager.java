...
public class SkinManager {
   ...
   public SkinManager(TextureManager textureManager, Path path, MinecraftSessionService minecraftSessionService, Executor executor) {
      ...
      this.skinCache = CacheBuilder.newBuilder().expireAfterAccess(Duration.ofSeconds(15L)).build(new CacheLoader<SkinManager.CacheKey, CompletableFuture<PlayerSkin>>() {
         public CompletableFuture<PlayerSkin> load(SkinManager.CacheKey cacheKey) {
            ...
            }, Util.backgroundExecutor()).thenComposeAsync((minecraftProfileTextures) -> {
               return SkinManager.this.registerTextures(cacheKey.profileId(), minecraftProfileTextures);
            }, executor);
         }

         // $FF: synthetic method
         public Object load(final Object object) throws Exception {
            return this.load((SkinManager.CacheKey)object);
         }
      });
   }
   ...
   public PlayerSkin getInsecureSkin(GameProfile gameProfile) {
      PlayerSkin playerSkin = (PlayerSkin)this.getOrLoad(gameProfile).getNow((Object)null);
   ...
   public CompletableFuture<PlayerSkin> getOrLoad(GameProfile gameProfile) {
      ...
      return (CompletableFuture)this.skinCache.getUnchecked(new SkinManager.CacheKey(gameProfile.getId(), property));
   }
   ...
   CompletableFuture<PlayerSkin> registerTextures(UUID uUID, MinecraftProfileTextures minecraftProfileTextures) {
      ...
      String string = (String)Optionull.map(minecraftProfileTexture, MinecraftProfileTexture::getUrl);
      MinecraftProfileTexture minecraftProfileTexture2 = minecraftProfileTextures.cape();
      CompletableFuture<ResourceLocation> completableFuture2 = minecraftProfileTexture2 != null ? this.capeTextures.getOrLoad(minecraftProfileTexture2) : CompletableFuture.completedFuture((Object)null);
      MinecraftProfileTexture minecraftProfileTexture3 = minecraftProfileTextures.elytra();
      CompletableFuture<ResourceLocation> completableFuture3 = minecraftProfileTexture3 != null ? this.elytraTextures.getOrLoad(minecraftProfileTexture3) : CompletableFuture.completedFuture((Object)null);
      return CompletableFuture.allOf(completableFuture, completableFuture2, completableFuture3).thenApply((void_) -> {
   ...
   private static class TextureCache {
      ...
      private CompletableFuture<ResourceLocation> registerTexture(MinecraftProfileTexture minecraftProfileTexture) {
         ...
         HttpTexture httpTexture = new HttpTexture(path.toFile(), minecraftProfileTexture.getUrl(), DefaultPlayerSkin.getDefaultTexture(), this.type == Type.SKIN, () -> {
            completableFuture.complete(resourceLocation);
         });
         this.textureManager.register((ResourceLocation)resourceLocation, (AbstractTexture)httpTexture);
         return completableFuture;
      }
