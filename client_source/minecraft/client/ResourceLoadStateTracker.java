...
public class ResourceLoadStateTracker {
   ...
   public void startReload(ResourceLoadStateTracker.ReloadReason reloadReason, List<PackResources> list) {
      ...
      this.reloadState = new ResourceLoadStateTracker.ReloadState(reloadReason, (List)list.stream().map(PackResources::packId).collect(ImmutableList.toImmutableList()));
   }
