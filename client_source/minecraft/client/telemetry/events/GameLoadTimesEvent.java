...
public class GameLoadTimesEvent {
   ...
   public synchronized void beginStep(TelemetryProperty<GameLoadTimesEvent.Measurement> telemetryProperty) {
      this.beginStep(telemetryProperty, (telemetryPropertyx) -> {
      ...
      telemetryEventSender.send(TelemetryEventType.GAME_LOAD_TIMES, (builder) -> {
         synchronized(this) {
            ...
            this.bootstrapTime.ifPresent((l) -> {
               builder.put(TelemetryProperty.LOAD_TIME_BOOTSTRAP_MS, new GameLoadTimesEvent.Measurement((int)l));
            });
   ...
   public static record Measurement(int millis) {
      ...
      static {
         CODEC = Codec.INT.xmap(GameLoadTimesEvent.Measurement::new, (measurement) -> {
