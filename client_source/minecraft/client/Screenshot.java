      ...
      Util.ioPool().execute(() -> {
         try {
            ...
            Component component = Component.literal(file3.getName()).withStyle(ChatFormatting.UNDERLINE).withStyle((style) -> {
               return style.withClickEvent(new ClickEvent(Action.OPEN_FILE, file3.getAbsolutePath()));
            });
            ...
            consumer.accept(Component.translatable("screenshot.failure", new Object[]{var7.getMessage()}));
         } finally {
            nativeImage.close();
         }
