...
public class BlockTintCache {
      ...
      try {
         ...
         for(int k = -1; k <= 1; ++k) {
            for(int l = -1; l <= 1; ++l) {
               ...
               BlockTintCache.CacheData cacheData = (BlockTintCache.CacheData)this.cache.remove(m);
               if (cacheData != null) {
   ...
   private BlockTintCache.CacheData findOrCreateChunkCache(int i, int j) {
      ...
      BlockTintCache.CacheData cacheData;
      BlockTintCache.CacheData cacheData2;
      try {
         cacheData = (BlockTintCache.CacheData)this.cache.get(l);
         if (cacheData != null) {
      ...
      BlockTintCache.CacheData cacheData3;
      try {
         cacheData = (BlockTintCache.CacheData)this.cache.get(l);
         if (cacheData != null) {
            cacheData2 = cacheData;
         ...
         if (this.cache.size() >= 256) {
            cacheData3 = (BlockTintCache.CacheData)this.cache.removeFirst();
            if (cacheData3 != null) {
   ...
   private static class CacheData {
      ...
      public int[] getLayer(int i) {
         ...
         try {
            is = (int[])this.cache.computeIfAbsent(i, (ix) -> {
