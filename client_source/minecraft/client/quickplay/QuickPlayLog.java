...
public class QuickPlayLog {
   ...
   public void log(Minecraft minecraft) {
      if (minecraft.gameMode != null && this.worldData != null) {
         Util.ioPool().execute(() -> {
            ...
            var10000.resultOrPartial(Util.prefix("Quick Play: ", var10002::error)).ifPresent((jsonElement) -> {
               try {
   ...
   private static record QuickPlayWorld(QuickPlayLog.Type type, String id, String name) {
      public static final MapCodec<QuickPlayLog.QuickPlayWorld> MAP_CODEC = RecordCodecBuilder.mapCodec((instance) -> {
         return instance.group(QuickPlayLog.Type.CODEC.fieldOf("type").forGetter(QuickPlayLog.QuickPlayWorld::type), ExtraCodecs.ESCAPED_STRING.fieldOf("id").forGetter(QuickPlayLog.QuickPlayWorld::id), Codec.STRING.fieldOf("name").forGetter(QuickPlayLog.QuickPlayWorld::name)).apply(instance, QuickPlayLog.QuickPlayWorld::new);
      });

      QuickPlayWorld(QuickPlayLog.Type type, String string, String string2) {
         this.type = type;
         this.id = string;
         this.name = string2;
      }
   ...
   private static record QuickPlayEntry(QuickPlayLog.QuickPlayWorld quickPlayWorld, Instant lastPlayedTime, GameType gamemode) {
      public static final Codec<QuickPlayLog.QuickPlayEntry> CODEC = RecordCodecBuilder.create((instance) -> {
         return instance.group(QuickPlayLog.QuickPlayWorld.MAP_CODEC.forGetter(QuickPlayLog.QuickPlayEntry::quickPlayWorld), ExtraCodecs.INSTANT_ISO8601.fieldOf("lastPlayedTime").forGetter(QuickPlayLog.QuickPlayEntry::lastPlayedTime), GameType.CODEC.fieldOf("gamemode").forGetter(QuickPlayLog.QuickPlayEntry::gamemode)).apply(instance, QuickPlayLog.QuickPlayEntry::new);
      });

      QuickPlayEntry(QuickPlayLog.QuickPlayWorld quickPlayWorld, Instant instant, GameType gameType) {
