...
public class AllayModel extends HierarchicalModel<Allay> implements ArmedModel {
   ...
   public void setupAnim(Allay allay, float f, float g, float h, float i, float j) {
      ...
      float l = Mth.cos(k) * 3.1415927F * 0.15F + g;
      ...
      if (allay.isDancing()) {
         ...
         s = Mth.cos(r) * 16.0F * 0.017453292F;
         t = allay.getSpinningProgress(m);
         float u = Mth.cos(r) * 14.0F * 0.017453292F;
         float v = Mth.cos(r) * 30.0F * 0.017453292F;
         this.root.yRot = allay.isSpinning() ? 12.566371F * t : this.root.yRot;
