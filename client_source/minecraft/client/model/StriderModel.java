...
public class StriderModel<T extends Strider> extends HierarchicalModel<T> {
   ...
   public void setupAnim(Strider strider, float f, float g, float h, float i, float j) {
      ...
      this.rightLeg.xRot = Mth.sin(f * 1.5F * 0.5F + 3.1415927F) * 2.0F * g;
      this.leftLeg.zRot = 0.17453292F * Mth.cos(f * 1.5F * 0.5F) * g;
      this.rightLeg.zRot = 0.17453292F * Mth.cos(f * 1.5F * 0.5F + 3.1415927F) * g;
      this.leftLeg.y = 8.0F + 2.0F * Mth.sin(f * 1.5F * 0.5F + 3.1415927F) * 2.0F * g;
      ...
      float l = Mth.cos(f * 1.5F + 3.1415927F) * g;
