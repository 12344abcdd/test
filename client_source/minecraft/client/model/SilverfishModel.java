...
public class SilverfishModel<T extends Entity> extends HierarchicalModel<T> {
   ...
   public SilverfishModel(ModelPart modelPart) {
      ...
      Arrays.setAll(this.bodyLayers, (i) -> {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      partDefinition.addOrReplaceChild(getLayerName(0), CubeListBuilder.create().texOffs(20, 0).addBox(-5.0F, 0.0F, (float)BODY_SIZES[2][2] * -0.5F, 10.0F, 8.0F, (float)BODY_SIZES[2][2]), PartPose.offset(0.0F, 16.0F, fs[2]));
      partDefinition.addOrReplaceChild(getLayerName(1), CubeListBuilder.create().texOffs(20, 11).addBox(-3.0F, 0.0F, (float)BODY_SIZES[4][2] * -0.5F, 6.0F, 4.0F, (float)BODY_SIZES[4][2]), PartPose.offset(0.0F, 20.0F, fs[4]));
      partDefinition.addOrReplaceChild(getLayerName(2), CubeListBuilder.create().texOffs(20, 18).addBox(-3.0F, 0.0F, (float)BODY_SIZES[4][2] * -0.5F, 6.0F, 5.0F, (float)BODY_SIZES[1][2]), PartPose.offset(0.0F, 19.0F, fs[1]));
   ...
   public void setupAnim(T entity, float f, float g, float h, float i, float j) {
      for(int k = 0; k < this.bodyParts.length; ++k) {
         this.bodyParts[k].yRot = Mth.cos(h * 0.9F + (float)k * 0.15F * 3.1415927F) * 3.1415927F * 0.05F * (float)(1 + Math.abs(k - 2));
         this.bodyParts[k].x = Mth.sin(h * 0.9F + (float)k * 0.15F * 3.1415927F) * 3.1415927F * 0.2F * (float)Math.abs(k - 2);
      }
