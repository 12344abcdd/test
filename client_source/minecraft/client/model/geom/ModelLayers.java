...
public class ModelLayers {
   ...
   public static ModelLayerLocation createRaftModelName(Type type) {
      return createLocation("raft/" + type.getName(), "main");
   }

   public static ModelLayerLocation createChestRaftModelName(Type type) {
      return createLocation("chest_raft/" + type.getName(), "main");
   }

   public static ModelLayerLocation createBoatModelName(Type type) {
      return createLocation("boat/" + type.getName(), "main");
   }

   public static ModelLayerLocation createChestBoatModelName(Type type) {
