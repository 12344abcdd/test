...
public class GuardianModel extends HierarchicalModel<Guardian> {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      for(int i = 0; i < 12; ++i) {
         ...
         float j = 3.1415927F * SPIKE_X_ROT[i];
         float k = 3.1415927F * SPIKE_Y_ROT[i];
         float l = 3.1415927F * SPIKE_Z_ROT[i];
   ...
   public void setupAnim(Guardian guardian, float f, float g, float h, float i, float j) {
      ...
      if (entity != null) {
         Vec3 vec3 = ((Entity)entity).getEyePosition(0.0F);
         ...
         Vec3 vec34 = (new Vec3(vec32.x - vec3.x, 0.0D, vec32.z - vec3.z)).normalize().yRot(1.5707964F);
      ...
      this.tailParts[0].yRot = Mth.sin(m) * 3.1415927F * 0.05F;
      this.tailParts[1].yRot = Mth.sin(m) * 3.1415927F * 0.1F;
      this.tailParts[2].yRot = Mth.sin(m) * 3.1415927F * 0.15F;
   }
