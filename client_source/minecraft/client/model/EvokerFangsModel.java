...
public class EvokerFangsModel<T extends Entity> extends HierarchicalModel<T> {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      partDefinition.addOrReplaceChild("lower_jaw", cubeListBuilder, PartPose.offsetAndRotation(-1.5F, 24.0F, 4.0F, 0.0F, 3.1415927F, 0.0F));
   ...
   public void setupAnim(T entity, float f, float g, float h, float i, float j) {
      ...
      k = 1.0F - k * k * k;
      this.upperJaw.zRot = 3.1415927F - k * 0.35F * 3.1415927F;
      this.lowerJaw.zRot = 3.1415927F + k * 0.35F * 3.1415927F;
