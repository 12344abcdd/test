...
public class MovementTutorialStepInstance implements TutorialStepInstance {
   ...
   private static final Component MOVE_TITLE = Component.translatable("tutorial.move.title", new Object[]{Tutorial.key("forward"), Tutorial.key("left"), Tutorial.key("back"), Tutorial.key("right")});
   ...
   public void onMouse(double d, double e) {
      if (Math.abs(d) > 0.01D || Math.abs(e) > 0.01D) {
         this.turned = true;
      }
