...
public interface GlyphProviderDefinition {
   ...
   public static record Conditional(GlyphProviderDefinition definition, FontOption.Filter filter) {
      public static final Codec<GlyphProviderDefinition.Conditional> CODEC = RecordCodecBuilder.create((instance) -> {
         return instance.group(GlyphProviderDefinition.MAP_CODEC.forGetter(GlyphProviderDefinition.Conditional::definition), FontOption.Filter.CODEC.optionalFieldOf("filter", FontOption.Filter.ALWAYS_PASS).forGetter(GlyphProviderDefinition.Conditional::filter)).apply(instance, GlyphProviderDefinition.Conditional::new);
      });

      public Conditional(GlyphProviderDefinition glyphProviderDefinition, FontOption.Filter filter) {
         this.definition = glyphProviderDefinition;
         this.filter = filter;
      }
