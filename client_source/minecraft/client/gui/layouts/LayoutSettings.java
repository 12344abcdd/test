...
public interface LayoutSettings {
   ...
   public static class LayoutSettingsImpl implements LayoutSettings {
      ...
      // $FF: synthetic method
      public LayoutSettings alignVertically(final float f) {
         return this.alignVertically(f);
      }

      // $FF: synthetic method
      public LayoutSettings alignHorizontally(final float f) {
         return this.alignHorizontally(f);
      }

      // $FF: synthetic method
      public LayoutSettings align(final float f, final float g) {
         return this.align(f, g);
      }

      // $FF: synthetic method
      public LayoutSettings paddingVertical(final int i) {
         return this.paddingVertical(i);
      }

      // $FF: synthetic method
      public LayoutSettings paddingHorizontal(final int i) {
         return this.paddingHorizontal(i);
      }

      // $FF: synthetic method
      public LayoutSettings paddingBottom(final int i) {
         return this.paddingBottom(i);
      }

      // $FF: synthetic method
      public LayoutSettings paddingRight(final int i) {
         return this.paddingRight(i);
      }

      // $FF: synthetic method
      public LayoutSettings paddingTop(final int i) {
         return this.paddingTop(i);
      }

      // $FF: synthetic method
      public LayoutSettings paddingLeft(final int i) {
         return this.paddingLeft(i);
      }

      // $FF: synthetic method
      public LayoutSettings padding(final int i, final int j, final int k, final int l) {
         return this.padding(i, j, k, l);
      }

      // $FF: synthetic method
      public LayoutSettings padding(final int i, final int j) {
         return this.padding(i, j);
      }

      // $FF: synthetic method
      public LayoutSettings padding(final int i) {
