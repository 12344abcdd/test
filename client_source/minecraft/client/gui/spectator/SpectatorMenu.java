...
public class SpectatorMenu {
   ...
   public SpectatorMenuItem getItem(int i) {
      ...
      if (this.page > 0 && i == 0) {
         ...
         return j >= 0 && j < this.category.getItems().size() ? (SpectatorMenuItem)MoreObjects.firstNonNull((SpectatorMenuItem)this.category.getItems().get(j), EMPTY_SLOT) : EMPTY_SLOT;
      }
   }
