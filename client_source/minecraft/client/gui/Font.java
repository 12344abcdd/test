...
public class Font {
   ...
   public int drawInBatch(String string, float f, float g, int i, boolean bl, Matrix4f matrix4f, MultiBufferSource multiBufferSource, Font.DisplayMode displayMode, int j, int k) {
      return this.drawInBatch(string, f, g, i, bl, matrix4f, multiBufferSource, displayMode, j, k, this.isBidirectional());
   }

   public int drawInBatch(String string, float f, float g, int i, boolean bl, Matrix4f matrix4f, MultiBufferSource multiBufferSource, Font.DisplayMode displayMode, int j, int k, boolean bl2) {
      return this.drawInternal(string, f, g, i, bl, matrix4f, multiBufferSource, displayMode, j, k, bl2);
   }

   public int drawInBatch(Component component, float f, float g, int i, boolean bl, Matrix4f matrix4f, MultiBufferSource multiBufferSource, Font.DisplayMode displayMode, int j, int k) {
      return this.drawInBatch(component.getVisualOrderText(), f, g, i, bl, matrix4f, multiBufferSource, displayMode, j, k);
   }

   public int drawInBatch(FormattedCharSequence formattedCharSequence, float f, float g, int i, boolean bl, Matrix4f matrix4f, MultiBufferSource multiBufferSource, Font.DisplayMode displayMode, int j, int k) {
   ...
   public void drawInBatch8xOutline(FormattedCharSequence formattedCharSequence, float f, float g, int i, int j, Matrix4f matrix4f, MultiBufferSource multiBufferSource, int k) {
         ...
         for(int n = -1; n <= 1; ++n) {
            if (m != 0 || n != 0) {
               ...
               formattedCharSequence.accept((lx, style, mx) -> {
                  ...
                  stringRenderOutput.x = fs[0] + (float)m * glyphInfo.getShadowOffset();
                  stringRenderOutput.y = g + (float)n * glyphInfo.getShadowOffset();
      ...
      Font.StringRenderOutput stringRenderOutput2 = new Font.StringRenderOutput(multiBufferSource, f, g, adjustColor(i), false, matrix4f, Font.DisplayMode.POLYGON_OFFSET, k);
   ...
   private int drawInternal(String string, float f, float g, int i, boolean bl, Matrix4f matrix4f, MultiBufferSource multiBufferSource, Font.DisplayMode displayMode, int j, int k, boolean bl2) {
      if (bl2) {
   ...
   private int drawInternal(FormattedCharSequence formattedCharSequence, float f, float g, int i, boolean bl, Matrix4f matrix4f, MultiBufferSource multiBufferSource, Font.DisplayMode displayMode, int j, int k) {
      i = adjustColor(i);
      Matrix4f matrix4f2 = new Matrix4f(matrix4f);
      if (bl) {
   ...
   private float renderText(String string, float f, float g, int i, boolean bl, Matrix4f matrix4f, MultiBufferSource multiBufferSource, Font.DisplayMode displayMode, int j, int k) {
   ...
   private float renderText(FormattedCharSequence formattedCharSequence, float f, float g, int i, boolean bl, Matrix4f matrix4f, MultiBufferSource multiBufferSource, Font.DisplayMode displayMode, int j, int k) {
      Font.StringRenderOutput stringRenderOutput = new Font.StringRenderOutput(multiBufferSource, f, g, i, bl, matrix4f, displayMode, k);
   ...
   class StringRenderOutput implements FormattedCharSink {
      ...
      public StringRenderOutput(final MultiBufferSource multiBufferSource, final float f, final float g, final int i, final boolean bl, final Matrix4f matrix4f, final Font.DisplayMode displayMode, final int j) {
      ...
      public float finish(int i, float f) {
         ...
         if (this.effects != null) {
            ...
            while(var9.hasNext()) {
               BakedGlyph.Effect effect = (BakedGlyph.Effect)var9.next();
