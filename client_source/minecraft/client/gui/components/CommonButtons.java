...
public class CommonButtons {
   public static SpriteIconButton language(int i, Button.OnPress onPress, boolean bl) {
      return SpriteIconButton.builder(Component.translatable("options.language"), onPress, bl).width(i).sprite(ResourceLocation.withDefaultNamespace("icon/language"), 15, 15).build();
   }
