...
public class TutorialToast implements Toast {
   ...
   public Toast.Visibility render(GuiGraphics guiGraphics, ToastComponent toastComponent, long l) {
      ...
      if (this.message == null) {
         guiGraphics.drawString(toastComponent.getMinecraft().font, (Component)this.title, 30, 12, -11534256, false);
      } else {
         guiGraphics.drawString(toastComponent.getMinecraft().font, (Component)this.title, 30, 7, -11534256, false);
         guiGraphics.drawString(toastComponent.getMinecraft().font, (Component)this.message, 30, 18, -16777216, false);
      }
