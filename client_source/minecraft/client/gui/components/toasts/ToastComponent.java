...
public class ToastComponent {
      ...
      if (!this.minecraft.options.hideGui) {
         ...
         if (!this.queued.isEmpty() && this.freeSlots() > 0) {
            this.queued.removeIf((toast) -> {
               ...
               if (j != -1) {
                  this.visible.add(new ToastComponent.ToastInstance(toast, j, i));
   ...
   public <T extends Toast> T getToast(Class<? extends T> class_, Object object) {
      ...
      ToastComponent.ToastInstance toastInstance;
      do {
         if (!var3.hasNext()) {
            ...
            } while(!class_.isAssignableFrom(toast.getClass()) || !toast.getToken().equals(object));

            return toast;
         }

         toastInstance = (ToastComponent.ToastInstance)var3.next();
      } while(toastInstance == null || !class_.isAssignableFrom(toastInstance.getToast().getClass()) || !toastInstance.getToast().getToken().equals(object));
