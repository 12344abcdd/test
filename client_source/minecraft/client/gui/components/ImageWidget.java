...
public abstract class ImageWidget extends AbstractWidget {
   ...
   static class Texture extends ImageWidget {
      ...
      protected void renderWidget(GuiGraphics guiGraphics, int i, int j, float f) {
         guiGraphics.blit(this.texture, this.getX(), this.getY(), this.getWidth(), this.getHeight(), 0.0F, 0.0F, this.getWidth(), this.getHeight(), this.textureWidth, this.textureHeight);
      }
   }
