...
public abstract class AbstractDebugChart {
   ...
   public void drawChart(GuiGraphics guiGraphics, int i, int j) {
      ...
      if (p > 0) {
         String var10000 = this.toDisplayString((double)m);
         String string = var10000 + " min";
         var10000 = this.toDisplayString((double)l / (double)p);
         String string2 = var10000 + " avg";
         var10000 = this.toDisplayString((double)n);
         String string3 = var10000 + " max";
         Font var10001 = this.font;
         int var10003 = i + 2;
         int var10004 = k - 60;
         Objects.requireNonNull(this.font);
         guiGraphics.drawString(var10001, string, var10003, var10004 - 9, 14737632);
         var10001 = this.font;
         var10003 = i + j / 2;
         var10004 = k - 60;
         Objects.requireNonNull(this.font);
         guiGraphics.drawCenteredString(var10001, string2, var10003, var10004 - 9, 14737632);
         var10001 = this.font;
         var10003 = i + j - this.font.width(string3) - 2;
         var10004 = k - 60;
         Objects.requireNonNull(this.font);
         guiGraphics.drawString(var10001, string3, var10003, var10004 - 9, 14737632);
      }
   ...
   protected void drawStringWithShade(GuiGraphics guiGraphics, String string, int i, int j) {
      ...
      int var10004 = i + this.font.width(string) + 1;
      Objects.requireNonNull(this.font);
      guiGraphics.fill(var10001, i, j, var10004, j + 9, -1873784752);
   ...
   protected int getSampleColor(double d, double e, int i, double f, int j, double g, int k) {
      d = Mth.clamp(d, e, g);
      return d < f ? ARGB32.lerp((float)((d - e) / (f - e)), i, j) : ARGB32.lerp((float)((d - f) / (g - f)), j, k);
   }
}
