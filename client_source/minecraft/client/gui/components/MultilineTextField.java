...
public class MultilineTextField {
   ...
   public boolean keyPressed(int i) {
      ...
      if (Screen.isSelectAll(i)) {
         ...
         MultilineTextField.StringView stringView;
         switch(i) {
         case 257:
         case 335:
            this.insertText("\n");
   ...
   private void reflowDisplayLines() {
      ...
      if (this.value.isEmpty()) {
         ...
         this.font.getSplitter().splitLines(this.value, this.width, Style.EMPTY, false, (style, i, j) -> {
            this.displayLines.add(new MultilineTextField.StringView(i, j));
         });
