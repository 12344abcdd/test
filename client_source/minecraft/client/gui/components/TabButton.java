...
public class TabButton extends AbstractWidget {
   ...
   private void renderFocusUnderline(GuiGraphics guiGraphics, Font font, int i) {
      int j = Math.min(font.width((FormattedText)this.getMessage()), this.getWidth() - 4);
   ...
   protected void updateWidgetNarration(NarrationElementOutput narrationElementOutput) {
      narrationElementOutput.add(NarratedElementType.TITLE, (Component)Component.translatable("gui.narrate.tab", new Object[]{this.tab.getTabTitle()}));
   }
