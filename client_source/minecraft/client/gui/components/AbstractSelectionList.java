...
public abstract class AbstractSelectionList<E extends AbstractSelectionList.Entry<E>> extends AbstractContainerWidget {
   ...
   public void setClampedScrollAmount(double d) {
      this.scrollAmount = Mth.clamp(d, 0.0D, (double)this.getMaxScroll());
   }
   ...
   public boolean mouseScrolled(double d, double e, double f, double g) {
      this.setScrollAmount(this.getScrollAmount() - g * (double)this.itemHeight / 2.0D);
      return true;
   }
   ...
   public void setFocused(@Nullable GuiEventListener guiEventListener) {
      ...
      if (i >= 0) {
         E entry = (AbstractSelectionList.Entry)this.children.get(i);
   ...
   protected E nextEntry(ScreenDirection screenDirection, Predicate<E> predicate, @Nullable E entry) {
      ...
      if (!this.children().isEmpty() && i != 0) {
         ...
         for(int k = j; k >= 0 && k < this.children.size(); k += i) {
            E entry2 = (AbstractSelectionList.Entry)this.children().get(k);
   ...
   protected E remove(int i) {
      E entry = (AbstractSelectionList.Entry)this.children.get(i);
      return this.removeEntry((AbstractSelectionList.Entry)this.children.get(i)) ? entry : null;
   }
   ...
   protected void narrateListElementPosition(NarrationElementOutput narrationElementOutput, E entry) {
      ...
      if (list.size() > 1) {
         ...
         if (i != -1) {
            narrationElementOutput.add(NarratedElementType.POSITION, (Component)Component.translatable("narrator.position.list", new Object[]{i + 1, list.size()}));
         }
      }
   ...
   private class TrackedList extends AbstractList<E> {
      ...
      public E set(int i, E entry) {
         E entry2 = (AbstractSelectionList.Entry)this.delegate.set(i, entry);
      ...
      public void add(final int i, final Object object) {
         this.add(i, (AbstractSelectionList.Entry)object);
      }

      // $FF: synthetic method
      public Object set(final int i, final Object object) {
         return this.set(i, (AbstractSelectionList.Entry)object);
      }
