...
public class ControlsScreen extends OptionsSubScreen {
   ...
   protected void addOptions() {
      this.list.addSmall(Button.builder(Component.translatable("options.mouse_settings"), (button) -> {
         this.minecraft.setScreen(new MouseSettingsScreen(this, this.options));
      }).build(), Button.builder(Component.translatable("controls.keybinds"), (button) -> {
