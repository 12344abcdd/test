...
public class AccessibilityOptionsScreen extends OptionsSubScreen {
   ...
   protected void addFooter() {
      ...
      linearLayout.addChild(Button.builder(Component.translatable("options.accessibility.link"), ConfirmLinkScreen.confirmLink(this, (URI)CommonLinks.ACCESSIBILITY_HELP)).build());
