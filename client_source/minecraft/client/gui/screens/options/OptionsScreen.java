...
public class OptionsScreen extends Screen {
   ...
   protected void init() {
      ...
      linearLayout.addChild(new StringWidget(TITLE, this.font), (Consumer)(LayoutSettings::alignHorizontallyCenter));
      ...
      rowHelper.addChild(this.openScreenButton(SKIN_CUSTOMIZATION, () -> {
         return new SkinCustomizationScreen(this, this.options);
      }));
      rowHelper.addChild(this.openScreenButton(SOUNDS, () -> {
         return new SoundOptionsScreen(this, this.options);
      }));
      rowHelper.addChild(this.openScreenButton(VIDEO, () -> {
         return new VideoSettingsScreen(this, this.minecraft, this.options);
      }));
      rowHelper.addChild(this.openScreenButton(CONTROLS, () -> {
         return new ControlsScreen(this, this.options);
      }));
      rowHelper.addChild(this.openScreenButton(LANGUAGE, () -> {
         return new LanguageSelectScreen(this, this.options, this.minecraft.getLanguageManager());
      }));
      rowHelper.addChild(this.openScreenButton(CHAT, () -> {
         return new ChatOptionsScreen(this, this.options);
      }));
      rowHelper.addChild(this.openScreenButton(RESOURCEPACK, () -> {
      ...
      rowHelper.addChild(this.openScreenButton(ACCESSIBILITY, () -> {
         return new AccessibilityOptionsScreen(this, this.options);
      }));
      Button button = (Button)rowHelper.addChild(this.openScreenButton(TELEMETRY, () -> {
      ...
      rowHelper.addChild(this.openScreenButton(CREDITS_AND_ATTRIBUTION, () -> {
         return new CreditsAndAttributionScreen(this);
      }));
      this.layout.addToContents(gridLayout);
      this.layout.addToFooter(Button.builder(CommonComponents.GUI_DONE, (buttonx) -> {
         this.onClose();
      }).width(200).build());
   ...
   private LayoutElement createOnlineButton() {
      if (this.minecraft.level != null && this.minecraft.hasSingleplayerServer()) {
         ...
         if (!this.minecraft.level.getLevelData().isHardcore()) {
            this.lockButton = new LockIconButton(0, 0, (button) -> {
               this.minecraft.setScreen(new ConfirmScreen(this::lockCallback, Component.translatable("difficulty.lock.title"), Component.translatable("difficulty.lock.question", new Object[]{this.minecraft.level.getLevelData().getDifficulty().getDisplayName()})));
            });
         ...
         return Button.builder(Component.translatable("options.online"), (button) -> {
   ...
   public static CycleButton<Difficulty> createDifficultyButton(int i, int j, String string, Minecraft minecraft) {
      return CycleButton.builder(Difficulty::getDisplayName).withValues((Object[])Difficulty.values()).withInitialValue(minecraft.level.getDifficulty()).create(i, j, 150, 20, Component.translatable(string), (cycleButton, difficulty) -> {
