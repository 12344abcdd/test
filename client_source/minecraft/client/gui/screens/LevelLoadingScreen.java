...
public class LevelLoadingScreen extends Screen {
   ...
   private Component getFormattedProgress() {
      return Component.translatable("loading.progress", new Object[]{Mth.clamp(this.progressListener.getProgress(), 0, 100)});
   }
      ...
      guiGraphics.drawManaged(() -> {
         ...
         for(int rx = 0; rx < p; ++rx) {
            for(int sx = 0; sx < p; ++sx) {
               ...
               int tx = r + rx * m;
               int u = s + sx * m;
               guiGraphics.fill(tx, u, tx + k, u + k, COLORS.getInt(chunkStatus) | -16777216);
            }
         }
