...
public class PlayerSocialManager {
   ...
   public void addPlayer(PlayerInfo playerInfo) {
      ...
      if (var4 instanceof SocialInteractionsScreen) {
         SocialInteractionsScreen socialInteractionsScreen = (SocialInteractionsScreen)var4;
   ...
   public void removePlayer(UUID uUID) {
      ...
      if (var3 instanceof SocialInteractionsScreen) {
         SocialInteractionsScreen socialInteractionsScreen = (SocialInteractionsScreen)var3;
