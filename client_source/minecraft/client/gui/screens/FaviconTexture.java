...
public class FaviconTexture implements AutoCloseable {
   ...
   public static FaviconTexture forWorld(TextureManager textureManager, String string) {
      String var10003 = Util.sanitizeName(string, ResourceLocation::validPathChar);
      return new FaviconTexture(textureManager, ResourceLocation.withDefaultNamespace("worlds/" + var10003 + "/" + String.valueOf(Hashing.sha1().hashUnencodedChars(string)) + "/icon"));
   }

   public static FaviconTexture forServer(TextureManager textureManager, String string) {
      String var10003 = String.valueOf(Hashing.sha1().hashUnencodedChars(string));
      return new FaviconTexture(textureManager, ResourceLocation.withDefaultNamespace("servers/" + var10003 + "/icon"));
   }
