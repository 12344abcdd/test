...
public abstract class WarningScreen extends Screen {
   ...
   protected WarningScreen(Component component, Component component2, Component component3) {
      this(component, component2, (Component)null, component3);
   }
   ...
   protected void init() {
      ...
      this.messageWidget = (FocusableTextWidget)linearLayout.addChild(new FocusableTextWidget(this.width - 100, this.message, this.font, 12), (Consumer)((layoutSettings) -> {
