...
public class ExperimentsScreen extends Screen {
   ...
   public ExperimentsScreen(Screen screen, PackRepository packRepository, Consumer<PackRepository> consumer) {
      ...
      Iterator var4 = packRepository.getAvailablePacks().iterator();
   ...
   protected void init() {
      ...
      linearLayout.addChild((new MultiLineTextWidget(INFO, this.font)).setMaxWidth(310), (Consumer)((layoutSettings) -> {
      ...
      this.packs.forEach((pack, boolean_) -> {
         builder.addSwitch(getHumanReadableTitle(pack), () -> {
            return this.packs.getBoolean(pack);
         }, (boolean_x) -> {
            this.packs.put(pack, boolean_x);
