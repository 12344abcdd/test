...
public class WorldSelectionList extends ObjectSelectionList<WorldSelectionList.Entry> {
   ...
   public WorldSelectionList(SelectWorldScreen selectWorldScreen, Minecraft minecraft, int i, int j, int k, int l, String string, @Nullable WorldSelectionList worldSelectionList) {
   ...
   public void setSelected(@Nullable WorldSelectionList.Entry entry) {
      ...
      if (entry instanceof WorldSelectionList.WorldListEntry) {
         ...
         var10001 = worldListEntry.summary;
      } else {
         var10001 = null;
      }
   ...
   public Optional<WorldSelectionList.WorldListEntry> getSelectedOpt() {
      WorldSelectionList.Entry entry = (WorldSelectionList.Entry)this.getSelected();
      if (entry instanceof WorldSelectionList.WorldListEntry) {
         WorldSelectionList.WorldListEntry worldListEntry = (WorldSelectionList.WorldListEntry)entry;
   ...
   public static class LoadingHeader extends WorldSelectionList.Entry {
      ...
      public void render(GuiGraphics guiGraphics, int i, int j, int k, int l, int m, int n, int o, boolean bl, float f) {
         int p = (this.minecraft.screen.width - this.minecraft.font.width((FormattedText)LOADING_LABEL)) / 2;
   ...
   public final class WorldListEntry extends WorldSelectionList.Entry implements AutoCloseable {
      ...
      public Component getNarration() {
         Component component = Component.translatable("narrator.select.world_info", new Object[]{this.summary.getLevelName(), Component.translationArg(new Date(this.summary.getLastPlayed())), this.summary.getInfo()});
      ...
      public void render(GuiGraphics guiGraphics, int i, int j, int k, int l, int m, int n, int o, boolean bl, float f) {
         ...
         int var10003 = k + 32 + 3;
         Objects.requireNonNull(this.minecraft.font);
         guiGraphics.drawString(var10001, string2, var10003, j + 9 + 3, -8355712, false);
         var10001 = this.minecraft.font;
         var10003 = k + 32 + 3;
         Objects.requireNonNull(this.minecraft.font);
         int var10004 = j + 9;
         Objects.requireNonNull(this.minecraft.font);
         guiGraphics.drawString(var10001, component, var10003, var10004 + 9 + 3, -8355712, false);
      ...
      public boolean mouseClicked(double d, double e, int i) {
         if (!this.summary.primaryActionActive()) {
            ...
            if (!(d - (double)WorldSelectionList.this.getRowLeft() <= 32.0D) && Util.getMillis() - this.lastClickTime >= 250L) {
      ...
      public void deleteWorld() {
         this.minecraft.setScreen(new ConfirmScreen((bl) -> {
            ...
            this.minecraft.setScreen(this.screen);
         }, Component.translatable("selectWorld.deleteQuestion"), Component.translatable("selectWorld.deleteWarning", new Object[]{this.summary.getLevelName()}), Component.translatable("selectWorld.deleteButton"), CommonComponents.GUI_CANCEL));
      }
         ...
         try {
            ...
            try {
               ...
               if (worldCreationContext.options().isOldCustomizedWorld()) {
                  this.minecraft.setScreen(new ConfirmScreen((bl) -> {
                     this.minecraft.setScreen((Screen)(bl ? CreateWorldScreen.createFromExisting(this.minecraft, this.screen, levelSettings, worldCreationContext, path) : this.screen));
