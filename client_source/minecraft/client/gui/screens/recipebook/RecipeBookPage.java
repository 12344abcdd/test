...
public class RecipeBookPage {
   ...
   public void render(GuiGraphics guiGraphics, int i, int j, int k, int l, float f) {
      if (this.totalPages > 1) {
         ...
         int m = this.minecraft.font.width((FormattedText)component);
         guiGraphics.drawString(this.minecraft.font, (Component)component, i - m / 2 + 73, j + 141, -1, false);
      }
      ...
      while(var9.hasNext()) {
         RecipeButton recipeButton = (RecipeButton)var9.next();
   ...
   public boolean mouseClicked(double d, double e, int i, int j, int k, int l, int m) {
      ...
      if (this.overlay.isVisible()) {
         ...
         do {
            ...
            recipeButton = (RecipeButton)var10.next();
         } while(!recipeButton.mouseClicked(d, e, i));
         ...
         if (i == 0) {
            ...
            this.overlay.init(this.minecraft, recipeButton.getCollection(), recipeButton.getX(), recipeButton.getY(), j + l / 2, k + 13 + m / 2, (float)recipeButton.getWidth());
         }
   ...
   public void recipesShown(List<RecipeHolder<?>> list) {
      ...
      while(var2.hasNext()) {
         RecipeShownListener recipeShownListener = (RecipeShownListener)var2.next();
