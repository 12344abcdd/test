...
public class RecipeBookComponent implements PlaceRecipe<Ingredient>, Renderable, GuiEventListener, NarratableEntry, RecipeShownListener {
   ...
   public void initVisuals() {
      ...
      while(var4.hasNext()) {
         RecipeBookCategories recipeBookCategories = (RecipeBookCategories)var4.next();
   ...
   private void updateCollections(boolean bl) {
      ...
      if (!string.isEmpty()) {
         ...
         if (clientPacketListener != null) {
            ...
            list2.removeIf((recipeCollection) -> {
               return !objectSet.contains(recipeCollection);
            });
         }
      }
   ...
   private void updateTabs() {
      ...
      while(true) {
         while(var5.hasNext()) {
            RecipeBookTabButton recipeBookTabButton = (RecipeBookTabButton)var5.next();
   ...
   public void render(GuiGraphics guiGraphics, int i, int j, float f) {
      if (this.isVisible()) {
         ...
         while(var7.hasNext()) {
            RecipeBookTabButton recipeBookTabButton = (RecipeBookTabButton)var7.next();
         ...
         if (this.recipeBookPage.mouseClicked(d, e, i, (this.width - 147) / 2 - this.xOffset, (this.height - 166) / 2, 147, 166)) {
            ...
            if (this.filterButton.mouseClicked(d, e, i)) {
               ...
               do {
                  ...
                  recipeBookTabButton = (RecipeBookTabButton)var6.next();
   ...
   public void recipesShown(List<RecipeHolder<?>> list) {
      ...
      while(var2.hasNext()) {
         RecipeHolder<?> recipeHolder = (RecipeHolder)var2.next();
   ...
   public void setupGhostRecipe(RecipeHolder<?> recipeHolder, List<Slot> list) {
      ...
      this.ghostRecipe.addIngredient(Ingredient.of(new ItemStack[]{itemStack}), ((Slot)list.get(0)).x, ((Slot)list.get(0)).y);
      this.placeRecipe(this.menu.getGridWidth(), this.menu.getGridHeight(), this.menu.getResultSlotIndex(), recipeHolder, recipeHolder.value().getIngredients().iterator(), 0);
   }
   ...
   public void updateNarration(NarrationElementOutput narrationElementOutput) {
      ...
      Screen.NarratableSearchResult narratableSearchResult = Screen.findNarratableWidget(list, (NarratableEntry)null);
