...
public class RecipeBookTabButton extends StateSwitchingButton {
   ...
   public void startAnimation(Minecraft minecraft) {
      ...
      if (minecraft.player.containerMenu instanceof RecipeBookMenu) {
         ...
         while(var4.hasNext()) {
            RecipeCollection recipeCollection = (RecipeCollection)var4.next();
            Iterator var6 = recipeCollection.getRecipes(clientRecipeBook.isFiltering((RecipeBookMenu)minecraft.player.containerMenu)).iterator();

            while(var6.hasNext()) {
               RecipeHolder<?> recipeHolder = (RecipeHolder)var6.next();
   ...
   public boolean updateVisibility(ClientRecipeBook clientRecipeBook) {
      ...
      if (list != null) {
         ...
         while(var3.hasNext()) {
            RecipeCollection recipeCollection = (RecipeCollection)var3.next();
