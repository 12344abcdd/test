...
public class RecipeCollection {
   ...
   public void canCraft(StackedContents stackedContents, int i, int j, RecipeBook recipeBook) {
      ...
      while(true) {
         while(var5.hasNext()) {
            RecipeHolder<?> recipeHolder = (RecipeHolder)var5.next();
            ...
            if (bl && stackedContents.canCraft(recipeHolder.value(), (IntList)null)) {
   ...
   public List<RecipeHolder<?>> getRecipes(boolean bl) {
      ...
      while(var4.hasNext()) {
         RecipeHolder<?> recipeHolder = (RecipeHolder)var4.next();
