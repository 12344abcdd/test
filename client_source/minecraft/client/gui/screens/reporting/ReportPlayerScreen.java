...
public class ReportPlayerScreen extends Screen {
   ...
   protected void init() {
      ...
      Button button = (Button)this.layout.addChild(Button.builder(REPORT_CHAT, (buttonx) -> {
      ...
      this.layout.addChild(Button.builder(REPORT_SKIN, (buttonx) -> {
      ...
      this.layout.addChild(Button.builder(REPORT_NAME, (buttonx) -> {
