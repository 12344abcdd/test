...
public abstract class AbstractReportScreen<B extends Report.Builder<?>> extends Screen {
   ...
   protected void createFooter() {
      this.attestation = (Checkbox)this.layout.addChild(Checkbox.builder(ATTESTATION_CHECKBOX, this.font).selected(this.reportBuilder.attested()).maxWidth(280).onValueChange((checkbox, bl) -> {
      ...
      this.sendButton = (Button)linearLayout.addChild(Button.builder(SEND_REPORT, (button) -> {
         this.sendReport();
      }).width(120).build());
   }
   ...
   protected void sendReport() {
      this.reportBuilder.build(this.reportingContext).ifLeft((result) -> {
         ...
         this.displayReportSendError(cannotBuildReason.message());
      });
   }
   ...
   private void onReportSendError(Throwable throwable) {
      ...
      if (var4 instanceof ThrowingComponent) {
         ThrowingComponent throwingComponent = (ThrowingComponent)var4;
   ...
   private void displayReportSendError(Component component) {
      ...
      this.minecraft.setScreen(GenericWaitingScreen.createCompleted(REPORT_ERROR_TITLE, component2, CommonComponents.GUI_BACK, () -> {
         this.minecraft.setScreen(this);
      }));
   }
   ...
   private class DiscardReportWarningScreen extends WarningScreen {
      ...
      protected Layout addFooterButtons() {
         ...
         linearLayout2.addChild(Button.builder(RETURN, (button) -> {
            this.onClose();
         }).build());
