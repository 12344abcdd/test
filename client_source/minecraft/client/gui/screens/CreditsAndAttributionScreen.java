...
public class CreditsAndAttributionScreen extends Screen {
   ...
   protected void init() {
      ...
      linearLayout.addChild(Button.builder(CREDITS_BUTTON, (button) -> {
         this.openCreditsScreen();
      }).width(210).build());
      linearLayout.addChild(Button.builder(ATTRIBUTION_BUTTON, ConfirmLinkScreen.confirmLink(this, (URI)CommonLinks.ATTRIBUTION)).width(210).build());
      linearLayout.addChild(Button.builder(LICENSES_BUTTON, ConfirmLinkScreen.confirmLink(this, (URI)CommonLinks.LICENSES)).width(210).build());
