...
public interface ClientTooltipComponent {
   ...
   static ClientTooltipComponent create(TooltipComponent tooltipComponent) {
      if (tooltipComponent instanceof BundleTooltip) {
         BundleTooltip bundleTooltip = (BundleTooltip)tooltipComponent;
         return new ClientBundleTooltip(bundleTooltip.contents());
      } else if (tooltipComponent instanceof ClientActivePlayersTooltip.ActivePlayersTooltip) {
         ClientActivePlayersTooltip.ActivePlayersTooltip activePlayersTooltip = (ClientActivePlayersTooltip.ActivePlayersTooltip)tooltipComponent;
