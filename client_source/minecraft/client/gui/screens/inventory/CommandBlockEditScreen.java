...
public class CommandBlockEditScreen extends AbstractCommandBlockEditScreen {
   ...
   protected void init() {
      ...
      this.modeButton = (CycleButton)this.addRenderableWidget(CycleButton.builder((mode) -> {
         ...
         return var10000;
      }).withValues((Object[])Mode.values()).displayOnlyValue().withInitialValue(this.mode).create(this.width / 2 - 50 - 100 - 4, 165, 100, 20, Component.translatable("advMode.mode"), (cycleButton, mode) -> {
         this.mode = mode;
      }));
