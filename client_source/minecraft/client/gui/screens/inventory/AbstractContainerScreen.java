...
public abstract class AbstractContainerScreen<T extends AbstractContainerMenu> extends Screen implements MenuAccess<T> {
   ...
   public void render(GuiGraphics guiGraphics, int i, int j, float f) {
      ...
      for(int m = 0; m < this.menu.slots.size(); ++m) {
         Slot slot = (Slot)this.menu.slots.get(m);
         if (slot.isActive()) {
      ...
      if (!this.snapbackItem.isEmpty()) {
         ...
         this.renderFloatingItem(guiGraphics, this.snapbackItem, q, r, (String)null);
      }
   ...
   public boolean mouseClicked(double d, double e, int i) {
      if (super.mouseClicked(d, e, i)) {
         ...
         if (i != 0 && i != 1 && !bl) {
            ...
            if ((Boolean)this.minecraft.options.touchscreen().get() && bl2 && this.menu.getCarried().isEmpty()) {
               this.onClose();
               return true;
            }
