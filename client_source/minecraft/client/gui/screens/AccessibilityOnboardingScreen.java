...
public class AccessibilityOnboardingScreen extends Screen {
   ...
   public void init() {
      ...
      this.textWidget = (FocusableTextWidget)linearLayout.addChild(new FocusableTextWidget(this.width, this.title, this.font), (Consumer)((layoutSettings) -> {
      ...
      if (var3 instanceof CycleButton) {
         CycleButton cycleButton = (CycleButton)var3;
      ...
      linearLayout.addChild(CommonButtons.language(150, (button) -> {
         this.closeAndSetScreen(new LanguageSelectScreen(this, this.minecraft.options, this.minecraft.getLanguageManager()));
      }, false));
      this.layout.addToFooter(Button.builder(CommonComponents.GUI_CONTINUE, (button) -> {
         this.onClose();
      }).build());
