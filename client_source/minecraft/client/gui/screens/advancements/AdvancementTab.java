...
public class AdvancementTab {
   ...
   public void scroll(double d, double e) {
      if (this.maxX - this.minX > 234) {
         this.scrollX = Mth.clamp(this.scrollX + d, (double)(-(this.maxX - 234)), 0.0D);
      }

      if (this.maxY - this.minY > 113) {
         this.scrollY = Mth.clamp(this.scrollY + e, (double)(-(this.maxY - 113)), 0.0D);
      }
   ...
   private void addWidget(AdvancementWidget advancementWidget, AdvancementHolder advancementHolder) {
      ...
      while(var7.hasNext()) {
         AdvancementWidget advancementWidget2 = (AdvancementWidget)var7.next();
