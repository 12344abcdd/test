...
public class BanNoticeScreens {
   ...
   public static ConfirmLinkScreen createNameBan(String string, Runnable runnable) {
      ...
      return new ConfirmLinkScreen((bl) -> {
         ...
         runnable.run();
      }, NAME_BAN_TITLE, Component.translatable("gui.banned.name.description", new Object[]{Component.literal(string).withStyle(ChatFormatting.YELLOW), Component.translationArg(CommonLinks.SUSPENSION_HELP)}), uRI, CommonComponents.GUI_ACKNOWLEDGE, true);
   }
   ...
   private static Component getBannedScreenText(BanDetails banDetails) {
      return Component.translatable("gui.banned.description", new Object[]{getBanReasonText(banDetails), getBanStatusText(banDetails), Component.translationArg(CommonLinks.SUSPENSION_HELP)});
   }
   ...
   private static Component getBanStatusText(BanDetails banDetails) {
      if (isTemporaryBan(banDetails)) {
         ...
         return Component.translatable("gui.banned.description.temporary", new Object[]{Component.translatable("gui.banned.description.temporary.duration", new Object[]{component}).withStyle(ChatFormatting.BOLD)});
      } else {
   ...
   static {
      ...
      SKIN_BAN_DESCRIPTION = Component.translatable("gui.banned.skin.description", new Object[]{Component.translationArg(CommonLinks.SUSPENSION_HELP)});
   }
}
