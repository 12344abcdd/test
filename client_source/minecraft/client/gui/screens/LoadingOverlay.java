...
public class LoadingOverlay extends Overlay {
   ...
   private static final int LOGO_BACKGROUND_COLOR = ARGB32.color(255, 239, 50, 61);
   private static final int LOGO_BACKGROUND_COLOR_DARK = ARGB32.color(255, 0, 0, 0);
   ...
   public static void registerTextures(Minecraft minecraft) {
      minecraft.getTextureManager().register((ResourceLocation)MOJANG_STUDIOS_LOGO_LOCATION, (AbstractTexture)(new LoadingOverlay.LogoTexture()));
   }
   ...
   public void render(GuiGraphics guiGraphics, int i, int j, float f) {
      ...
      if (g >= 1.0F) {
         ...
         n = Mth.ceil(Mth.clamp((double)h, 0.15D, 1.0D) * 255.0D);
         guiGraphics.fill(RenderType.guiOverlay(), 0, 0, k, l, replaceAlpha(BRAND_BACKGROUND.getAsInt(), n));
      ...
      n = (int)((double)guiGraphics.guiWidth() * 0.5D);
      int s = (int)((double)guiGraphics.guiHeight() * 0.5D);
      double d = Math.min((double)guiGraphics.guiWidth() * 0.75D, (double)guiGraphics.guiHeight()) * 0.25D;
      int t = (int)(d * 0.5D);
      double e = d * 4.0D;
      int u = (int)(e * 0.5D);
      ...
      int v = (int)((double)guiGraphics.guiHeight() * 0.8325D);
   ...
   private void drawProgressBar(GuiGraphics guiGraphics, int i, int j, int k, int l, float f) {
      ...
      int o = ARGB32.color(n, 255, 255, 255);
